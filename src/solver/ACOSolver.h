...
struct ACOParams {
  ...
  // Some-touches Fase 2: anti-convergencia del ACO. Cuatro cambios opt-in
  // para mitigar que las hormigas caigan consistentemente en los mismos
  ...
  //      Default = 2 (legacy); Phase 2 sugiere 50 (ratio ~25x menor).
  int    tau_min_factor = 2;
