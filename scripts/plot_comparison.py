...
ax.set_title("Coste por instancia — best vs ACO vs Random (i01–i30, 600s/inst)")
...
ax.set_title("ACO vs Random — puntos bajo y=x significan que ACO es mejor")
